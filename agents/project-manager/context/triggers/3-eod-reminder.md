...
Only if LARK_EXIT is non-zero (Lark failed after all retries), append a failure note inline to `standup/briefings/YYYY-MM/YYYY-MM-DD.md` if that file exists. Do not create any new files. Do not create any alerts folder.
