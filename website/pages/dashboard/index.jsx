...
import { tallyElements, dominantElement } from '../../lib/bazi';
...
export default function Dashboard() {
  ...
  const userPillars = profile?.pillars || data?.userPillars || null;
            ...
            <div className={styles.card}>
              ...
              {upcomingBirthdays.length > 0 ? (
                    ...
                    <li key={m.id}>
                      <Link href={`/dashboard/inner-circle/${m.id}`}>
                        ...
                        <span className={styles.bdayDays}>
                          {m.daysUntil === 0 ? 'today' : m.daysUntil === 1 ? 'tomorrow' : `in ${m.daysUntil} day${m.daysUntil === 1 ? '' : 's'}`}
                        </span>
                      </Link>
                    </li>
                  ))}
                ...
                <p className={accountStyles.muted}>
                  <Link href="/dashboard/inner-circle/new">Add your inner circle</Link> to see whose birthday is coming up.
                </p>
              )}
            </div>
          </section>
