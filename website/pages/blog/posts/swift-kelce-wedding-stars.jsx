        ...
        <div className="container">
          <div className={styles.body}>
            ...
            <div className={styles.pivotBanner}>
              ...
              <p>This is where the Mahjong Mirror framework comes in. We don't speak in terms of good and bad. We speak in terms of risk. The Fire Horse isn't a curse - it's fast, passionate, chaotic. High risk and high reward. The question isn't whether the fire is there. The question is which direction it burns.</p>
            </div>
            ...
            <figure className={styles.inlineFigure}>
              <Image
                ...
                alt="Elemental comparison: Taylor (Earth, Fire, Water) and Travis (Earth, Water, Fire) with crossing lines showing the mirror effect"
                width={720}
                height={720}
                style={{ width: '100%', height: 'auto' }}
              />
              <figcaption>Their elements mirror each other almost perfectly. 3 of 4 elements present.</figcaption>
            </figure>
            ...
            <figure className={styles.inlineFigure}>
              <Image
                src="/images/blog/swift-kelce-tiles.webp"
                alt="Six mahjong tiles arranged in two rows showing Taylor and Travis's zodiac signs - four glowing gold as power signs"
                width={720}
                height={720}
                style={{ width: '100%', height: 'auto' }}
              />
              <figcaption>Four of their six combined signs are power signs.</figcaption>
            </figure>

            <p>Across their combined year, month, and day charts, four of six signs are power signs. Travis's three signs - Snake, Rooster, Snake - all fall in the same compatibility group. That gives him natural inner peace, confidence, and balance. It's not something he works for. It's born into him. You can see it in how he carries himself.</p>
            ...
            <figure className={styles.inlineFigure}>
              <Image
                src="/images/blog/swift-kelce-silhouette.webp"
                alt="Two silhouettes at sunset - one holding a microphone, the other a football - their shadows merging into one"
                width={720}
                height={720}
                style={{ width: '100%', height: 'auto' }}
              />
