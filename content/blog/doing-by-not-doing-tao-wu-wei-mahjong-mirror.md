...
faqs:
  ...
  - q: "What is the uncarved wood image in the Tao Te Ching?"
    a: "Uncarved wood represents the state before commitment, when all possibilities are still open. The moment you carve wood, you fix it to one shape. Lao Tzu argues that this pre-commitment state deserves careful attention. Applied to decisions, it is the moment before you lock in a direction, when honest reflection can still change the shape of the outcome."
  - q: "What does 'empty the hub' mean in Taoism?"
    a: "In the wheel image, the empty space at the hub is what allows the axle to fit, making the wheel turn. Filling that space with more material would make the wheel useless. Applied to decisions and daily life, it means protecting the open space where reflection happens, rather than filling every moment with more action, more plans, and more force."
cta:
  overline: "See How These Ideas Apply to Your Decisions"
  heading: "Explore the Mahjong Mirror"
  body: "The Mahjong Mirror is the practical framework that brings this kind of reflection into real decisions. The book walks you through all four angles in a way that's immediately usable."
