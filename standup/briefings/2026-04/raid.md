...
|----|------|-----------|--------|-------|--------|
| R-01 | Resend domain not verified — email notifications only reach account owner | High | Medium | Trac | Open — switch RESEND_FROM to pm@edge8.ai once edge8.ai verified at resend.com/domains |
...
|----|-------|---------|-------|--------|
| I-01 | Resend email limited to account owner in testing mode | Medium | Trac | Open — verify edge8.ai domain at resend.com/domains |
| I-02 | Check-in files not updated since 2026-04-11 | Medium | All | Open — reminder sent EOD 2026-04-14 |

## Dependencies

| ID | Dependency | Dependent On | Owner | Status |
|----|-----------|-------------|-------|--------|
| D-01 | Email notifications to full team | edge8.ai domain verification in Resend | Trac | Blocked |
